...
import masque_red_death_icon from "./project/masque_red_death.jpg"
  ...
  return (
    <div className="App">
      ...
      <div className='project-container'>
        ...
        <Project project={{ name: "Java Renderer", image: null, description: "This is a rendering engine built in Java using LWJGL and OpenGL. This was one of my favorite projects to work on and supports many cool features such as dynamic lighting, physics, and much more!", link: [{ href: "https://github.com/AlexDorian7/java-renderer", text: "Github" }] }} />
      </div>
